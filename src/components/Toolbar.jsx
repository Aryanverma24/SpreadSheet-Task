  ...
  return (
   ...
   <div className="flex justify-between items-center shadow-sm bg-white">
      <div className="flex w-[40%] ">
        ...
        <button className="btn px-4 py-1  border border-gray-300">Hide Fields</button>
        <button className="btn px-4 py-1 border border-gray-300">Sort</button>
        <button className="btn px-4 py-1 border border-gray-300">Filter</button>
        <button className="btn px-4 py-1 border border-gray-300">Cell View</button>
      </div>
